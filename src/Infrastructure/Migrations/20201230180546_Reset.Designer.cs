...
namespace TIMSBack.Infrastructure.Migrations
{
    ...
    [Migration("20201230180546_Reset")]
    partial class Reset
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TIMSBack.Domain.Entities.Inventory.Transfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TIMSBack.Domain.Entities.Manufacturing.WorkOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("FinishedGood")
                        .HasColumnType("int");

                    b.Property<int>("InputWareHouseId")
                        .HasColumnType("int");

                    b.Property<int>("MaterialLoading")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TIMSBack.Domain.Entities.ProductOnHand", b =>
                {
                    ...
                    b.Property<int>("AwaitingQuantity")
                        .HasColumnType("int");

                    b.Property<int>("CommitedQuantity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TIMSBack.Domain.Entities.Inventory.Transfer", b =>
                {
                    b.HasOne("TIMSBack.Domain.Entities.WareHouse", "DestinationWareHouse")
                        .WithMany("DestinationWareHouses")
                    ...
                    b.HasOne("TIMSBack.Domain.Entities.WareHouse", "SourceWareHouse")
                        .WithMany("SourceWareHouses")
